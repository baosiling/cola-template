 ...
 * <p>
 * This provider is @Singleton scope as it provider the InstanceInfo for both
 * DiscoveryClient and ApplicationInfoManager, and need to provide the same InstanceInfo to both.
 */
@Singleton
public class EurekaConfigBasedInstanceInfoProvider implements Provider<InstanceInfo> {
    ...
    public InstanceInfo get() {
        if (instanceInfo == null) {
            ...
            // set the appropriate id for the instanceInfo, failing back to datacenter Id  if
            ...
            if (config instanceof RefreshableInstanceConfig) {
                //Refresh AWS data center info, and return up to data address
