...
public interface LookupService<T> {
    ...
    /**
     * Returns the {@link Application} object which is basically a container of
    ...
    /**
     * Returns the list of {@link InstanceInfo}s matching the passed in id.
     * A single {@link InstanceInfo} can possibly be registered w/ more than one
     * {@link Applications}s
     * @param id
     * @return list of {@link InstanceInfo}s or emptylist
     */
     ...
     * </p>
     *
     * @param virtualHostname the virtual host name that is associated to the server.
     * @param secure indicates whether this is a HTTP or a HTTPS request - secure means HTTPS
     * @return the {@link InstanceInfo} information which contains the public host name
     *          of the next server in line to process the request based on the
