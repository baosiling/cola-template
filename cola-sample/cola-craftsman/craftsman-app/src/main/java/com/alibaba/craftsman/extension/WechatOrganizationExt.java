...
@Extension(bizId = "organize", useCase = "getByCropId", scenario = "wechat")
public class WechatOrganizationExt implements OrganizationExtPtI {
    ...
    public List<Department> listDepartmentBy(String cropId) {
        List<DepartmentDO> departmentDOList = departmentTunnel.listByCropId(cropId, "Y");
